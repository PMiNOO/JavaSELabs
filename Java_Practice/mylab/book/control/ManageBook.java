...
public class ManageBook {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n==== 가격 변경 ====");
        Publication publicationToModify = publications[6];
        int originalPrice = publicationToModify.getPrice();
        System.out.println(publicationToModify.getTitle() + " 변경 전 가격: " + originalPrice + "원");
        modifyPrice(publicationToModify);
        System.out.println(publicationToModify.getTitle() + " 변경 후 가격: " + publicationToModify.getPrice() + "원");
        System.out.println("차액: " + (originalPrice - publicationToModify.getPrice()) + "원");
